<div class="add-creditors">
    <div class="creditor-details">
        <h2>Manage Creditors</h2>
        <p>Perform various actions to manage your creditors efficiently.</p>
        <div class="action-buttons">
            <button class="circular-btn" onclick="openAddCreditorForm()">
                <span class="material-icons">add</span>
                <span class="tooltip-text">Add Creditor</span>
            </button>
            <button class="circular-btn" onclick="viewCreditors()">
                <span class="material-icons">visibility</span>
                <span class="tooltip-text">View Creditors</span>
            </button>
            <button class="circular-btn" onclick="deleteCreditor()">
                <span class="material-icons">delete</span>
                <span class="tooltip-text">Delete Creditors</span>
            </button>
            <button class="circular-btn" onclick="updateCreditor()">
                <span class="material-icons">edit</span>
                <span class="tooltip-text">Update Creditors</span>
            </button>
        </div>
    </div>
    ...
    <div class="creditor-popup-form" id="creditorPopup">
        <div class="form-container">
            ...
            <form>
                ...
                <button type="submit" class="submit-btn">Add Creditor</button>
            </form>
        </div>
    </div>
</div>
